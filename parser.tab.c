...
{
  "$end", "error", "$undefined", "ALIAS", "BYE", "CD", "END", "ERR", "IN",
  "LS", "OUT", "STRING", "UNALIAS", "$accept", "cmd_line", YY_NULLPTR
};
#endif
...
{
       0,     0,     0,     0,    12,    11,     0,     0,     0,     8,
       0,     0,     6,     0,     2,     0,    10,     4,     9,     0,
       1,     0,     3,     7,     5
};
